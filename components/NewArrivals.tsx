...
export default function NewArrivals() {
  ...
  useEffect(() => {
    const fetchNewArrivals = async () => {
      try {
        ...
        console.error('Yeni ürünler yüklenirken hata:', err)
  ...
  // Carousel API'si değiştiğinde sayfa numaralarını güncelle
  useEffect(() => {
    if (!api) {
      return
    }
