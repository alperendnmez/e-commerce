                ...
                <div className=''>
                  <Card className='rounded-none shadow-none border-none'>
                    ...
                    >
                      <div className='flex justify-between'>
                        <div className='flex flex-col gap-1 pl-3 pt-3'>
                          {product.isHot && (
                            <Badge
                              variant={'outline'}
                              className='w-max bg-background text-sm font-medium font-light'
                            >
                              Yeni
                            </Badge>
                          )}
                          {product.discountPrecent && (
                            <Badge
                              variant={'outline'}
                              className='w-max bg-background text-sm font-medium text-red-500'
                            >
                      ...
                      <Button className='mx-3 mb-3 bg-background py-6 text-primary hover:text-primary-foreground shadow-none'>
                        Sepete Ekle
                      </Button>
                    </CardContent>
                  </Card>
